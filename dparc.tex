...
\emph{Streak} alerts are checked against the \gls{OUO} catalog at SLAC before release.
\emph{Non-streak} alerts and \emph{streak} alerts agreed with \gls{JPL} \gls{NEO} group  are to be published to the world at large within 60 seconds of the original raw image being taken.
