...
\section{Data Production system architecture} \label{sec:dparc}
...
As the permanent scientific record of the survey, no more than 1\% of the raw images or telemetry may be lost or corrupted.
...
The Chile disaster recovery plan will cover the Chile \gls{DAC}.  \action{CS}{May}{Chile disaster recovery docs}
...
50\% of \gls{DRP} will be done at IN2P3.
