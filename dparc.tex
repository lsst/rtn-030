...
See also the USDF Disaster Recovery Plan \citeds{RTN-078}.
...
The data in the cloud is merely a cache; a full copy is always held at the \gls{USDF} hence any Rubin data at the DAC is expendable.
...
Chile DevOps team are responsible for the Chile DAC.
Most applications deployed on the Chile DAC will be deployed by DM's SQuaRE team.
The applications will be same as deployed on the USDF DAC.
...
The \gls{CNRS} staff at \gls{IN2P3} are fully responsible fir the FrDF.
...
\gls{ROE} staff are responsible for the UKDF noting that \gls{IRIS} is a shared computing facility beyond their control.
