...
This enclave holds the only \gls{OUO} data on the project, a file containing a catalog of satellite orbit information.
Access to this data is limited to a highly vetted list of administrators and operators who are a small subset of Rubin staff.
