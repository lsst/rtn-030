...
h. Require that users log out of the system after [Assignment: organization-defined time period] of expected inactivity or when [Assignment: organization-defined circumstances].}&{Y}&{}&{IPA groups are in place for summit and unix groups at SLAC which restrict privileges of individual users.
