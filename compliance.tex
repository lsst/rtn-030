...
{3.7.5 Require multifactor authentication to establish nonlocal maintenance sessions via external network connections and terminate such connections when nonlocal maintenance is complete.}&{N}&{Y}&{Chile dont do 2FA yet. \gls{Duo} has the capability to kill sessions.} \\ \hline
