...
Each site has its own security policies (need doc refs) \action{RD,FH}{Mar 2022}{Handle for security docs \gls{US},Fr DFs}

UKDF falls under the \gls{IRIS} security policies listed on \url{https://www.iris.ac.uk/security/}.
...
There will  be a \gls{DAC} in Chile to support Chilean users. The \gls{UK} intends to host a DAC for \gls{UK} users.
