...
These team members will have to have \gls{SLAC} accounts to perform this work - \gls{SLAC} accounts are governed by (need doc).\action{JC}{Jun 2024}{Handle for doc covering users accounts at \gls{SLAC}}
...
Each site has its own security policies (need doc refs) \action{JC,FH}{Jun 2024}{Handle for security docs \gls{US},Fr DFs}
